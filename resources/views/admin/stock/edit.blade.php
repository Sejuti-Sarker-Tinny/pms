                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 @error('supplier_id') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                <select name="supplier_id" id="supplier_id" class="form-control">
                                    ...
                                    <option value="{{ $supplier->id }}" @if ( $data->id ==
                        ...
                        <div class="form-group row mb-3 @error('carton_number') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="carton_number"
                                    value="{{ $data->carton_number }}" placeholder="Carton Number" required>
                                @error('carton_number')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3 @error('box_per_carton') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="box_per_carton"
                                    value="{{ $data->box_per_carton }}" placeholder="Box Per Carton Number" required>
                        ...
                        <div class="form-group row mb-3 @error('pata_per_box') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="pata_per_box"
                                    value="{{ $data->pata_per_box }}" placeholder="Pata Per Box Number" required>
                                @error('pata_per_box')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row mb-3 @error('product_unit_per_pata') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="product_unit_per_pata"
                                    value="{{ $data->product_unit_per_pata }}" placeholder="Product Unit Per Pata Number" required>
                        ...
                        <div class="form-group row mb-3 @error('product_price_per_unit') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" class="form-control" name="product_price_per_unit"
                        ...
                        <div class="form-group row mb-3 @error('purchase_remarks') is-invalid @enderror">
                            ...
                            <div class="col-sm-6">
                                <textarea type="text" class="form-control" name="Purchase Remarks"
                                    value="{{ $data->purchase_remarks }}"
                                    required> </textarea>
